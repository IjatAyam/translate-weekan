...
<p class="mb-1"><b>Embed :</b> Copy / Paste embed code in above text box</p>',
    ...
    array (
      ...
      array (
        ...
        'featured_courses' => 'Free courses',
        'trending_courses' => 'Paid courses',
...
<b>Live</b> = Will be used with you Live PayPal credentials to make actual transaction with normal users with PayPal account.',
  ...
  array (
    ...
    array (
      ...
      'featured_course' => 'Free <span>Course.</span>',
    ...
    array (
      ...
      'pay_securely_paypal' => 'Pay securely with Billplz',
    ...
    array (
      ...
      'featured_course' => '<span>Free</span> Course.',
      'sort_by' => '<b>Sort</b> By',
      'popular' => 'Popular',
      'none' => 'None',
      'trending' => 'Paid',
    ...
    array (
      ...
      'teachers' => 'Teachers',
      'our_professionals' => 'Learn with them',
    ...
    array (
      ...
      array (
        ...
        'browse_featured_course' => 'Browse Our<span> Paid Course.</span>',
        ...
        'trending_courses' => 'Paid <span>Courses.</span>',
        'popular_courses' => 'Popular <span>Courses.</span>',
        'view_all_news' => 'View All News',
        'view_all_trending_courses' => 'View All Paid Courses',
